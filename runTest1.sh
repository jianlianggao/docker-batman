...
wget https://raw.githubusercontent.com/jianlianggao/batman/master/test_data/test_data_new/batmanOptions.txt -O /usr/local/bin/batmanOptions.txt

wget https://raw.githubusercontent.com/jianlianggao/batman/master/test_data/test_data_new/metabolitesList.csv -O /usr/local/bin/metabolitesList.csv

wget https://raw.githubusercontent.com/jianlianggao/batman/master/test_data/test_data_new/multi_data_user.csv -O /usr/local/bin/multi_data_user.csv
